package com.alhudaghifari.bildghifar.utils;

/**
 * Created by Alhudaghifari on 21:41 06/11/18
 */
public class Otsu {

    public double getOtsuThreshold(int[] grayScaleHistogram, int length) {

        double[] p = getProbabilities(grayScaleHistogram, length);
        double [] Wo = getWo(p);
        double W = getW(p);
